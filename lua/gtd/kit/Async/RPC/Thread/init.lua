...
local Session = require('gtd.kit.Async.RPC.Session')

---@class gtd.kit.Async.RPC.Thread
---@field private thread uv.luv_thread_t
---@field private session gtd.kit.Async.RPC.Session
local Thread = {}
Thread.__index = Thread

---Create new thread.
---@param dispatcher_ fun(session: gtd.kit.Async.RPC.Session)
