...
---@param encoding? gtd.kit.LSP.PositionEncodingKind
...
---@param bufnr integer
---@param position gtd.kit.LSP.Position
---@param from_encoding? gtd.kit.LSP.PositionEncodingKind
...
---@param position gtd.kit.LSP.Position
---@param from_encoding gtd.kit.LSP.PositionEncodingKind
---@param to_encoding gtd.kit.LSP.PositionEncodingKind
