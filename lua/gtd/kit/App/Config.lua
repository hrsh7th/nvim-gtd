...
---@field private _cache gtd.kit.App.Cache
---@field private _default gtd.kit.App.Config.SchemaInternal
---@field private _global gtd.kit.App.Config.SchemaInternal
---@field private _filetype table<string, gtd.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, gtd.kit.App.Config.SchemaInternal>
local Config = {}
...
---@return gtd.kit.App.Config.Schema
function Config:get()
